...
class TubeTests {
	...
	void testGetNormal() {
        ...
        Ray mainRay = new Ray(new Point(0, 0, 0), new Vector(1, 0, 0));
        double radius = 1.0;
        ...
        // Assert that the actual normal vector (the same as the first test) is approximately equal to the expected normal
        assertEquals(expectedNormal, actualNormal, "getNormal should return the correct normal vector on the tube axis");
	}
