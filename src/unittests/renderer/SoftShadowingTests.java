...
//	}
	...
	public void complicatedPicture() {
		...
		scene.lights.add(new SpotLight(new Color(700, 400, 400), new Point(40, 40, 115), new Vector(-1, -1, -4)) //
			.setKl(4E-4).setKq(2E-5).setRadius(10));
		scene.lights.add(new SpotLight(new Color(YELLOW), new Point (50, 50, -25) , new Vector(1, 1, -0.5).scale(-1)).setKl(0.0001).setKq(0.0000001).setRadius(15));
	...
	public void complicatedPictureNoSoft() {
		...
		scene.lights.add(new SpotLight(new Color(YELLOW), new Point (50, 50, -25) , new Vector(1, 1, -0.5).scale(-1)).setKl(0.0001).setKq(0.0000001));
		scene.lights.add(new DirectionalLight(new Color(GREEN), new Vector (2, 1, -0.5)));
		camera.setImageWriter(new ImageWriter("faceObjectsPictureNoSoft", 600, 600)).build().renderImage().writeToImage();
	}
}
